(()=>{
 const map={
  ...
  '.hero .ey':'eyebrow','.hero h1':'h1a','.hero h1 span':'h1b','.hero p':'hero',
  '.hero .actions a:nth-child(1)':'open','.hero .actions a:nth-child(2)':'discover','.hero .actions a:nth-child(3)':'start',
  ...
  '.section .title h2':'what','.section .title p':'whatDesc',
