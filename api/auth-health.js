...
module.exports = async function handler(req, res) {
  ...
  // Provider credentials and real user flows are intentionally not probed here.
  // A successful infrastructure probe is never treated as provider certification.
  ...
  const degraded = Object.values(checks).includes('down') || Object.values(checks).includes('degraded');
