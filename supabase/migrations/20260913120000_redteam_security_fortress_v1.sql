...
-- Remove session-controlled pg_temp from all previously exposed SECURITY DEFINER paths.
...
ALTER FUNCTION public.create_conversation_invite(text) SET search_path = pg_catalog, public, private, auth;
ALTER FUNCTION public.create_group_conversation(text, uuid[]) SET search_path = pg_catalog, public, private, auth;
